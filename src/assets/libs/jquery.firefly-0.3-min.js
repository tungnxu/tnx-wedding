...
(function ($) {
    ...
    $.firefly.create = function (pixelSize) {
        ...
        return spark.css({
            ...
            // transform : `translate(${$.firefly.offsetLeft + $.firefly.random(($.firefly.eleWidth - 50))}px,-${$.firefly.offsetTop + $.firefly.random(($.firefly.eleHeight - 50))}px)`,
    ...
    $.firefly.fly = function (sp) {
        ...
        // $(sp).css('-webkit-transform',`translate(${$.firefly.offsetLeft + $.firefly.random(($.firefly.eleWidth - 50))}px,${$.firefly.offsetTop + $.firefly.random(($.firefly.eleHeight - 50))}px)`);
        $(sp).animate({
        //    transform: `translate(${$.firefly.offsetLeft + $.firefly.random(($.firefly.eleWidth - 50))}px,-${$.firefly.offsetTop + $.firefly.random(($.firefly.eleHeight - 50))}px)`,
            top: $.firefly.offsetTop + $.firefly.random(($.firefly.eleHeight - 50)),	//offsets
